...
- [Ecosystem Abstractions](#ecosystem-abstractions)
...
*   **Preamble & License Headers**: Every handcrafted and generated source file (including bindings, helpers, and hooks) must strictly contain the repository copyright and licensing header.
...
Programmatic build and link hooks for **Code Assets** leverage three specialized sibling packages in this repository:
